                ...
                <div className="grid auto-rows-min gap-4 md:grid-cols-3 lg:grid-cols-4">
                    {campuses.map((campus) => (
                        <Card key={campus.id} className="hover:shadow-lg transition-shadow duration-200">
                            <Link href={`/admin/impact-assessment/${campus.id}`} className="flex flex-col items-center gap-3">
                                <CardContent>
                                    <div className="flex flex-col items-center gap-3">
                                        ...
                                        >
                                            <span className="flex items-center gap-1">
                                                ...
                                                {campus.impact_assessments_count} Assessment{campus.impact_assessments_count > 1 ? "s" : ""}
                                            </span>
                                        </Badge>
                                    </div>
                                </CardContent>
