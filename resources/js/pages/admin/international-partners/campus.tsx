...
type Campus = BaseCampus & {
    international_partners_count: number;
};
                ...
                <div className="grid auto-rows-min gap-4 md:grid-cols-3 lg:grid-cols-4">
                    {campuses.map((campus) => (
                        <Card key={campus.id} className="hover:shadow-lg transition-shadow duration-200">
                            <Link href={`/admin/international-partners/${campus.id}`} className="flex flex-col items-center gap-2">
                                <CardContent>
                                    <div className="flex flex-col items-center gap-3">
                                        ...
                                        >
                                            <span className="flex items-center gap-1">
                                                ...
                                                {campus.international_partners_count} Partnership{campus.international_partners_count > 1 ? "s" : ""}
                                            </span>
                                        </Badge>
                                    </div>
                                </CardContent>
