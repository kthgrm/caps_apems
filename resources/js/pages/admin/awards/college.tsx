                ...
                <div className="grid auto-rows-min gap-4 md:grid-cols-3 lg:grid-cols-4">
                    {colleges.map((college) => (
                        <Card key={college.id} className='hover:shadow-lg transition-shadow duration-200'>
                            <Link href={`/admin/awards-recognition/${campus.id}/${college.id}/awards`} className="flex flex-col items-center gap-2">
                                <CardContent>
                                ...
                                >
                                    <span className="flex items-center gap-1">
                                        ...
                                        {college.awards_count} Award{college.awards_count > 1 ? "s" : ""}
                                    </span>
                                </Badge>
                            </Link>
                        </Card>
